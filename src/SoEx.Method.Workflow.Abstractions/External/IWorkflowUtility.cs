...
public interface IWorkflowUtility
{
    ...
    Task<long> DrainEraseRequestsAsync();
    ...
    Task<long> SweepAbandonedAsync(long olderThanSeconds);
    ...
    Task<long> ReviewDeadlinesAsync(long escalateWithinSeconds);
}
