...
var onboardStep = new GovernedStep<IMembershipManager>(
    system.Endpoint, system.Serializer, idempotency, keys, index, nameof(IMembershipManager.OnboardStep));
